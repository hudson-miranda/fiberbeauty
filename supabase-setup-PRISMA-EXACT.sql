-- Fiber Beauty - Script SQL MÍNIMO para corresponder exatamente ao schema Prisma
...
-- Criar enums EXATAMENTE como no schema Prisma
...
-- Tabela de usuários (seguindo EXATAMENTE o schema Prisma)
CREATE TABLE "users" (
...
-- Tabela de clientes (APENAS os campos do schema Prisma)
...
-- Tabela de atendimentos (com userId, não attendantId)
...
-- Cliente de exemplo
INSERT INTO "clients" ("firstName", "lastName", "cpf") 
VALUES ('Cliente', 'Exemplo', '000.000.000-00');
